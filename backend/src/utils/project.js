...
export const removeSpecialChars = (charsToRemove, text) => {
  /**
...
export const removeTabs = (text) => {
  return text.replace("\t", " ");
};

export const removeCasing = (removeCasing, text) => {
...
export const removeDuplicates = (remove, texts) => {
  /**
