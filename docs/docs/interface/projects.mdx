...
Each card features dual linear progress bars that visually compare your annotation progress with that of the entire team. Additionally, two actionable buttons provide direct access to the project's [Dashboard](dashboard) and the [Annotation View](annotation) for detailed work and review.
