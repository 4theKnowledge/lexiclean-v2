    ...
    <>
      ...
      <Grid style={{ margin: "0rem 0.25rem 0rem 0.25rem" }}>
        <Grid sm={12} md={6}>
          ...
          When LexiClean processes your corpora, it uses an inverse tf-idf of
          masked out-of-vocabulary tokens to identify documents that will give
          biggest 'bang-for-buck' normalisations. Additionally, additional
          automatic labelling functions can be applied as seen on the right.
          <p style={{ marginTop: "0.5rem" }}>
            <strong>Label digits as in-vocabulary:</strong> Considers digits (1,
            22, 388, etc) as in-vocabulary.
          </p>
        </Grid>
        <Grid sm={12} md={6}>
